...
class ExternalPurchases(luigi.ExternalTask):
    ...
    def output(self):
        return luigi.LocalTarget("/home/ec2-user/code/data/purchases.csv")

class PurchasesTotal(luigi.Task):
    task_namespace = 'testing'

    def output(self):
        return luigi.LocalTarget("/home/ec2-user/code/data/luigi/total.txt")
...
class QueryPostgres(luigi.Task):
    ...
    def output(self):
        return luigi.LocalTarget("/home/ec2-user/code/data/luigi/same_purchases.csv")
